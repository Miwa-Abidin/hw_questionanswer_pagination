...
urlpatterns = [
    ...
    path('api/categorys/', views.CategoryCreateApiView.as_view()),
    path('api/questions/', views.QuestionAnswerCreateApiView.as_view()),
    path('api/categorys/<int:pk>/', views.CategoryRetrieveUpdateDestroy.as_view()),
    path('api/questions/<int:pk>/', views.QuestionAnswerRetrieveUpdateDestroy.as_view()),
